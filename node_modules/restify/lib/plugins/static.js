...
function serveStatic(opts) {
    ...
    assert.optionalString(opts.fileName, 'options.fileName');
    ...
    function serve(req, res, next) {
        ...
        if (opts.fileName) {
            console.log('xxx___PPPPPPPaaaaaaaaasssssaaaaaaaaasssssaaaaaaaaasssssaaaaaaaaasssss');
            file = path.join(opts.directory, opts.fileName);
        }
